...
export default function About() {
  return (
    <section
      id="about"
      className="relative z-10 -mt-10 overflow-hidden rounded-t-[2.5rem] bg-white px-6 py-24 text-slate-900 sm:px-10"
    >
      <div className="float-slow absolute left-8 top-14 h-28 w-28 rounded-full bg-blue-100/70 blur-3xl" />
      <div className="float absolute bottom-12 right-10 h-40 w-40 rounded-full bg-sky-100/70 blur-3xl" />

      <div className="relative container mx-auto px-0 lg:px-12">
        <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div className="fade-up">
            ...
            <h2 className="mt-6 text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl">
              Building simple and meaningful digital experiences.
            </h2>
          ...
          <div className="fade-up delay-1 rounded-[2rem] border border-slate-200 bg-slate-50/90 p-8 shadow-[0_20px_60px_rgba(15,23,42,0.08)]">
            ...
            {codingProfiles.map((profile, index) => {
              ...
              return (
                <a
                  ...
                  className={`fade-up rounded-[1.75rem] border border-slate-200 bg-white p-6 text-center shadow-[0_18px_50px_rgba(15,23,42,0.08)] transition hover:-translate-y-1 hover:border-blue-200 hover:shadow-[0_22px_60px_rgba(15,23,42,0.12)] ${delayClass}`}
                >
                  <span className="mx-auto inline-flex h-[3rem] w-[3rem] items-center justify-center rounded-xl bg-slate-50">
                    <Icon size={38} className={profile.iconClassName} />
                  </span>
